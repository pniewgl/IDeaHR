...
def setup_gcp_clients():
    ...
    try:
        ...
        # 5. Inicjalizacja Vertex AI (z jawnym credentials - NOWOŚĆ)
        vertexai.init(
        ...
        # Wypisz pełny błąd, abyśmy widzieli co się dzieje
