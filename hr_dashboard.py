...
# Jeśli tam wystąpi błąd, tutaj zmienne będą None
try:
...
def get_candidates():
    if not bigquery_client:
        st.error("Moduł BigQuery nie jest połączony.")
        return []
    ...
    try:
        ...
        # Nie wyświetlamy tu błędu metadata, po prostu zwracamy pustą listę
        # Błąd główny wyświetli się w app.py
        return []
